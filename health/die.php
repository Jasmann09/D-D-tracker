...
<body>
    <form action="index.php" method="post">
        <div class="form-group">
          <label for="exampleInputEmail1">Enter Disease</label>
          <input type="text" class="form-control" id="inputdisease" aria-describedby="emailHelp" placeholder="Disease" name="inputdisease">
