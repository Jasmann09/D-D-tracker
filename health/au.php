...
<h1>Disease/Deficency possible :-</h1>
<div class="ss">
<?php
 $def= $_POST['inputbd'];
 $sym=$_POST['inputsym'];
 $sql=" SELECT * FROM `tracker` WHERE bodypart='$def' and symptoms='$sym'";
...
<h3>Always Recommended to consult Medical Expert Here is Our List of Experinced and Certified Doctors :-</h3>
<hr>
<?php
$sql="SELECT * FROM `doc`";
